...
public class QueryRequestProvider extends BusinessRequestProvider {
	private static Logger LOG = LoggerFactory
			.getLogger(QueryRequestProvider.class);
	private boolean enable = false;
	private Map<String, SingleBusinessConf> businesses ;

	public QueryRequestProvider(BusinessType type) {
		super(type);
	}
	...
	public static void main(String[] args) {
		QueryRequestProvider provider = new QueryRequestProvider(BusinessType.COMMAND);
